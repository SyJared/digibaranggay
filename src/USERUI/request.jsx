...
function Requests() {
  ...
  const handlePinSubmit = async (pin) => {
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/digidb/request.php`, {
        method: "POST",
  ...
  const handleNotifyAdmin = async () => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/digidb/notify_request_again.php`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
